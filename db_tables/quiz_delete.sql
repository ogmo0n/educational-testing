...
--
-- Table structure for table `quiz_delete`
--

CREATE TABLE IF NOT EXISTS `quiz_delete` (
  `deleteAttemptId` int(11) NOT NULL AUTO_INCREMENT,
  `attemptId` int(11) NOT NULL,
  `faculty_username` char(30) NOT NULL,
  ...
  PRIMARY KEY (`deleteAttemptId`),
  UNIQUE KEY `type` (`type`,`username`,`course_id`,`consumer_key`,`resource_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5242 ;
