...
if ($action == 'print_test1') {
	...
	if ($ok) {
		...
		if ($_SESSION['isStudent'] == 1) {
			...
			$hiddenInput = "</table><input type='hidden' name='attemptId' value='{$_SESSION['attemptId']}' />";
			...
			$submitBtn = "<input type='submit' id='submit' class='submit' value='Submit Quiz' name='grade' onclick='needToConfirm = true;return confirm('Are you sure you want to submit your answers?');'/>";
			$closingFormTag = "</form>";
			...
			if (in_array(0, $_SESSION['arrQuestion'], true)) {
				...
				if ($_SESSION['count'] < 1) {
					if ($unanswered == 1) {
						$page .= 
							$js_changeBtnColor.$js_classSubmit.$hiddenInput.$divClassButtons.$disabledPrevBtn.$nextBtn.$closingDivTag.$divClassBox.$promptSpan1.$submitBtn.$closingDivTag.$closingFormTag;
					} else {
						$page .= 
							$js_changeBtnColor.$js_classNext.$hiddenInput.$divClassButtons.$disabledPrevBtn.$nextBtn.$closingDivTag.$divClassBox.$promptSpan2.$submitBtn.$closingDivTag.$closingFormTag;
					}
				...
				// Form buttons for last test question
					...
					if ($unanswered == 1) {
						$page .= 
							$js_changeBtnColor.$js_classSubmit.$hiddenInput.$divClassButtons.$prevBtn.$disabledNextBtn.$closingDivTag.$divClassBox.$promptSpan1.$submitBtn.$closingDivTag.$closingFormTag;
					} else {
						$page .= 
							$js_changeBtnColor.$js_classPrevious.$hiddenInput.$divClassButtons.$prevBtn.$disabledNextBtn.$closingDivTag.$divClassBox.$promptSpan2.$submitBtn.$closingDivTag.$closingFormTag;
					}
				...
				// Form buttons for test questions other than first or last.
					...
					if ($unanswered == 1) {
						$page .= 
							$js_changeBtnColor.$js_classSubmit.$hiddenInput.$divClassButtons.$prevBtn.$nextBtn.$closingDivTag.$divClassBox.$promptSpan1.$submitBtn.$closingDivTag.$closingFormTag;
					} else {
						$page .= 
							$js_changeBtnColor.$js_classNext.$hiddenInput.$divClassButtons.$prevBtn.$nextBtn.$closingDivTag.$divClassBox.$promptSpan2.$submitBtn.$closingDivTag.$closingFormTag;
					}
				}
			 ...
			 */
				...
				if ($_SESSION['count'] < 1) {
					$page .= 
						$js_submitBtnColor.$hiddenInput.$divClassButtons.$disabledPrevBtn.$nextBtn.$closingDivTag.$divClassBox.$promptSpanAll.$submitBtn.$closingDivTag.$closingFormTag;

				// Form buttons for last test question
				} else if ($_SESSION['count'] == $_SESSION['numberQuestions'] - 1) {
					$page .= 
						$js_submitBtnColor.$hiddenInput.$divClassButtons.$prevBtn.$disabledNextBtn.$closingDivTag.$divClassBox.$promptSpanAll.$submitBtn.$closingDivTag.$closingFormTag;

				// Form buttons for test questions other than first or last.
				} else {
					$page .= 
						$js_submitBtnColor.$hiddenInput.$divClassButtons.$prevBtn.$nextBtn.$closingDivTag.$divClassBox.$promptSpanAll.$submitBtn.$closingDivTag.$closingFormTag;
				}
			}
		}
	}
